...
class CarInterface(CarInterfaceBase):
  ...
  def get_pid_accel_limits(CP, current_speed, cruise_speed):
    ...
    gas_max_bp = [0., 8., 16., 24., 32., 40., 50., 70., 80., 100., 130.]
    gas_max_v = [1.65, 1.3, 1.19, 1.4, 1.0, 0.9, 0.7, 0.3, 0.3, 0.2, 0.24]
    #gas_max_v = [1.8, 1.4, 1.23, 1.4, 1.0, 0.9, 0.7, 0.3, 0.3, 0.2, 0.24]
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=[], disable_radar=False):  # pylint: disable=dangerous-default-value
    ...
    if ret.lateralTuning.which() == 'torque':
      ...
      torque_lat_accel_factor = 3.866842361627636 #LAT_ACCEL_FACTOR		
      torque_friction = 0.06869638264150804 #FRICTION
      ret.maxLateralAccel = 2.2496820850331134 #MAX_LAT_ACCEL_MEASURED		
      #토크
