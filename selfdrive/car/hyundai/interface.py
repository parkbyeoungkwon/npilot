...
class CarInterface(CarInterfaceBase):
  ...
  def get_pid_accel_limits(CP, current_speed, cruise_speed):
    ...
    #gas_max_v = [1.7, 1.4, 1.1, 1.4, 1.0, 0.9, 0.7, 0.3, 0.3, 0.24]

    #gas_max_bp = [0., 8., 20., 50., 70., 130., 150.]
    #gas_max_v = [1.65, 1.4, 1.23, 0.67, 0.47, 0.16, 0.1]
